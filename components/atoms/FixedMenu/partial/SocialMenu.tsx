          ...
          {socialLinks.map((socialItem, index) => (
            ...
            >
              <div className="flex items-center hover:bg-blue-100 custome-transition p-2">
                <li
                  className={`${socialItem.bg}  custome-translate border-black w-[32px] h-[32px] flex  rounded-full items-center  justify-center`}
                >
                  <Image
                ...
                <span className="inline ml-2">{socialItem.content}</span>
              </div>
            </Link>
          ))}
        </ul>
