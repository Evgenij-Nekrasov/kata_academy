export const accordionItems = [
  {
    ...
    content: (
      <div>
        ...
        HTML tags in the content such as <u>underline tag</u>, <i>italic</i>, or
        even another list like this:
        <ul>
          <li>Bread</li>
          <li>Eggs</li>
          <li>Milk</li>
  ...
  },
  {
    ...
    content: (
      <div>
        <strong>This is the second items accordion body.</strong> It is hidden
