...
const Analytics = () => {
  return (
    // Main image
    <>
      <div className={`mt-20 max-g:mt-0 pt-11 pb-52 max-g:pb-40 bg-lightRed`}>
        <CardWrapper>
          <div className="[&>*]:text-black mt-20">
            ...
            >
              Обучаем <span className="bg-violet">Big Data Analytics</span>{' '}
              online
            </Typography>
            <p className="mt-5">
            ...
            <Link href="https://t.me/Evgenie061" target="_blank">
              <Button className="hover:bg-violet" background="transparent">
                <Typography
          ...
          <div className="max-g:hidden flex items-center  justify-center bg-violet relative w-[40vw] h-[40vw]   rounded-[50%]">
            <Image
        ...
        title={
          <>
            <h2 className="h2 max-md:text-[27px] max-sm:text-[23px] max-sm:text-[20px] md:leading-10">
              Kata Academy - это <span className="bg-violet">новый подход</span>
              к обучению программистов
            </h2>
          </>
        }
        paragraph={
